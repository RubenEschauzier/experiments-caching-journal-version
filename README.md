...
Different caching approaches with multiple sizes
Refinement pattern-only
Hyperparameter sweep
- Data overlap (both within two queries in a row and compared to total sequence)
- Within-interest querying / Instantiation similarity values
- Unique data sources accessed (# of documents)
